          ...
          <div className = "flex flex-row gap-30 justify-center items-center mt-4">
            <section className = "group inline-block items-center justify-center space-y-2 max-h-lg max-w-md p-3 border-double border-8 border-sky-500 rounded-xl shadow-md shadow-emerald-100 mr-7 hover:scale-110 duration-300">
              ...
              <div className = "group flex flex-row mt-5 flex-wrap flex-grow ">
                  ...
                  <BsNewspaper size = "38" className = "pl-1.5"/><div className = "font-sans px-3 py-1 mr-4 text-white text-opacity-60">Articles</div>
                 <time className = "px-1.5 py-1 mr-3 text-white text-opacity-60">April 7, 2023</time>
                 
                  <GiSandsOfTime size = "38" className = "pl-1.5"/><div className = "px-3 py-1 mr-3 text-white text-opacity-60 mb-7">
                    10 min read</div>
              </div>
            
              <a>
                <h1 className = "mb-2 text-3xl font-bold text-blue-200 tracking-tight">First blog</h1>
              </a>
            ...
            <section className = "group inline-block items-center justify-center space-y-2 max-h-lg max-w-md p-3 border-double border-8 border-sky-500 rounded-xl shadow-md shadow-emerald-100 mr-7 hover:scale-110 duration-300">
              ...
              <a>
                <h1 class = "mb-2 text-3xl font-bold text-blue-200 tracking-tight">First blog</h1>
              </a>
              <p class = "mb-4 font-sans">This blog is a community that welcomes Fellows from a wide range of experiences and backgrounds. What perspective or experience will you bring to the fellowship to strengthen our community?</p>
            </section>
     </div>
