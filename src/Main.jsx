...
const titles = () => {
  return (
    <div class="flex flex-col justify-center items-center prose-xl mb-7">
      ...
      <h1 class="font-extrabold mt-3 text-6xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-lightFourth ">
        Articles
      </h1>
      {/* dark:text-gray-300  */}
      ...
      {/* dark:text-gray-300 */}
      <h2 className="font-thick prose-xl text-gray-600">🌇 Recent posts</h2>
        ...
        <Link to="/Posts" className="hover:cursor-pointer">
          ...
          <section className="group inline-block rounded-xl items-center justify-center space-y-2 max-h-lg max-w-md p-3 border-double border-8 border-black shadow-md shadow-emerald-100 mr-7 hover:scale-110 duration-300">
            ...
            <div className="group flex flex-row mt-5 flex-wrap flex-grow mr-6">
              ...
              <div className="bg-black inline-block rounded-md px-3 py-1 mr-6">
                <div className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-lightFourth ">
                  NEW!
                </div>
              </div>
              ...
              <GiSandsOfTime size="38" className="text-black mt-3.5" />
              <div className="px-3 py-1 mr-3 text-black text-opacity-60 mt-3.5">
                10 min read
              </div>
            </div>
            {/* dark:text-blue-200  */}
            <h1 className="mb-2 mt-7 text-3xl font-bold text-black tracking-tight">
              First blog
            </h1>
            {/* dark:text-white */}
