...
const design = (props) => {
  ...
  return (
    <>
      ...
      <footer className={dark ? `m-6 border-gray-200 flex flex-row justify-between items-center text-gray-300`
      :`m-6 border-gray-200 flex flex-row justify-between items-center text-gray-800 `}>
        ...
        <div className="flex flex-wrap items-center space-x-8 mx-6 ">
          <a
            ...
            className= {dark ? `hover:scale-150 duration-200 text-gray-400 hover:text-gray-300`
